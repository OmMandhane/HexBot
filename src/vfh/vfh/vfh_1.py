...
class VFH(Node):
    def __init__(self, vfh_config):
        ...
        self.vmax = 1.0  # Maximum velocity 0.3 prev
    ...
    def calculate_histogram_field_vector(self, ranges, angles):
        ...
        for i, distance in enumerate(ranges):
            ...
            #sector_index = int((angles_mapped[i] / self.sector_size)) % num_sectors
            certainty = 100/(100+np.exp(-(self.a - self.b * distance)))  # TODO: maybe we need to calculate as VFF does
    ...
    def find_velocity(self, teta):
        ...
        v = self.vmax * (1.0 - min(z / 0.5, 0.98)) 
